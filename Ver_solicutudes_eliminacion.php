...
<body>
        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    ...
                    <li><a href="#"><i class="fa-solid fa-user-xmark"></i>Solicitudes</a></li>
    ...
    <h1 class = "text-center p-3">Ver solicitudes de eliminacion</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                        ...
                        include ("controlador/eliminar_usuario.php");  //Esta es para eliminar el usuario de la bd de clientes
                        include ("controlador/eliminar_usuario_solicitud.php"); //Este es para eliminarlo de la solicitud
                        
                        $sql = $connection-> query("SELECT * FROM solicitud_borrar_datos");
                        while($datos = $sql->fetch_object()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a onclick="return eliminar()" href="Ver_solicutudes_eliminacion.php?idCliente=<?= $datos->idCliente ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                        <?php }
                    ?>
