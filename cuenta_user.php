...
<body>
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li class="active"><a href="cuenta_user.php">Mi cuenta</a></li>
    ...
    <div class="container mt-5">
        ...
        <form action="modificar_datos_user.php" method="POST">

            <?php
                include ("modificar_datos_user.php");
            ?>

            <input type="hidden" name="Correo_cliente" value="<?= $Correo_cliente ?>">
            <input type="hidden" name="idCliente" value="<?= $idCliente ?>">

            <input type="hidden" name="Password_cliente" value="<?= $Password_cliente ?>">
            <input type="hidden" name="Telefono_cliente" value="<?= $Telefono_cliente ?>">


            <div class="form-group">
                <label for="nombre">Nombre:</label>
                <input type="text" class="form-control" name="Nombres_cliente" value="<?php echo $Nombre_usuario; ?>">
            </div>
            <div class="form-group">
                <label for="apellidoPaterno">Apellido Paterno:</label>
                <input required type="text" class="form-control" name="Apellido_paterno"
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="Correo_cliente" value="<?php echo $Correo_cliente; ?>"
                    readonly>
            </div>

            <div class="form-group" >
                <button type="submit" class="btn btn-primary" name="btn-modificar-datos" href="#"
                    onclick="mostrarAlert()">Modificar datos</button>

                <button type="submit" class="btn btn-danger" name="btn-eliminar-datos" >Solicitar eliminar datos</button>
            </div>
